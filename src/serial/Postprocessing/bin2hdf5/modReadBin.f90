...
module MTSKplane
  ...
  parameter(varname_Kplane = (/'u','v','w','p','t','uk','vk','wk','pk','tk'/))
...
! Dimension range for tsdata 
    ...
    subroutine ReadTSKplane(kindex, nvar_output, varindex_output, varout, zloc, dzdk)
     ...
     real(8) :: tsdata_pe(nvar,nxpt,nypt,1,ntpoint)
     integer :: istat, k1
...
module MTSIplane
  ...
  parameter(varname_Iplane = (/'u','v','w','p','t','ui','vi','wi','pi','ti'/))
contains
    ...
    subroutine ReadTSIplane(iindex, nvar_output, varindex_output, varout)
       ...
       real(8) :: tsdata_pe(nvar,1,nypt,nzpt,ntpoint)
       character(4) :: fnum4, fnum5
       character(300) :: fileinput
...
module MTSJplane
  ...
  parameter(varname_Jplane = (/'u','v','w','p','t','ui','vi','wi','pi','ti'/))
  contains
