...
!  use MDerivative
  use HDF5
  implicit none
  integer, parameter :: nvar_output = 26
  integer :: iascii
...
!    character(100), dimension(:), pointer :: dname
    character(100), dimension(:), allocatable :: dname
...
!         ibe_k = ibe_k_inp + ()*iskip_k_inp + (nnn-1)*ibuffer_k
 ...
 !    call GetDNSInfo_kplane(nodes_k,iascii, nskip, dx_kp, dy_kp, ibe_k, iend_k, & 
 !                           jbe_k_inp, jend_k_inp )
...
!stop
       ...
       call ReadTSKplane(kplane(k),nvar_output-3,varindex_output(1:(nvar_output-3)),tsdata(1:(nvar_output-3),:,:,:), zloc_kp, dzdk_kp)

       tsdata(nvar_output-2,:,:,:) = tsdata(8,:,:,:)*dzdk_kp
       tsdata(nvar_output-1,:,:,:) = tsdata(11,:,:,:)*dzdk_kp
       tsdata(nvar_output,:,:,:) = tsdata(14,:,:,:)*dzdk_kp

!       tsdata(nvar_output-1,:,:,:) = tsdata(8,:,:,:)*dzdk_kp
!       tsdata(nvar_output,:,:,:)   = tsdata(8,:,:,:)*dzdk_kp
...
!                            kbe_i_inp, kend_i_inp)
       ...
       call ReadTSIplane(iplane(i), nvar_output-3, varindex_output(1:(nvar_output-3)),tsdata(1:(nvar_output-3),:,:,:))

       tsdata(nvar_output-2,:,:,:) = tsdata(6,:,:,:)*dx_ip
       tsdata(nvar_output-1,:,:,:) = tsdata(9,:,:,:)*dx_ip
       tsdata(nvar_output,:,:,:)   = tsdata(12,:,:,:)*dx_ip
...
!                              kbe_j_inp, kend_j_inp)
       ...
       idim = nxpoint
       call ReadTSJplane(jplane(j), nvar_output-3, varindex_output(1:(nvar_output-3)),tsdata(1:(nvar_output-3),:,:,:))

       tsdata(nvar_output-2,:,:,:) = tsdata(7,:,:,:)*dy_jp
       tsdata(nvar_output-1,:,:,:) = tsdata(10,:,:,:)*dy_jp
       tsdata(nvar_output,:,:,:)   = tsdata(13,:,:,:)*dy_jp
  ...
  contains
    ...
    subroutine InitTSkplane_HDF5()
      ...
      TSkplane%dname(8) = "uz"
      TSkplane%dname(9) = "vx"
      TSkplane%dname(10) = "vy"
      TSkplane%dname(11) = "vz"
      TSkplane%dname(12) = "wx"
      TSkplane%dname(13) = "wy"
      TSkplane%dname(14) = "wz"
      TSkplane%dname(15) = "uxx"
      TSkplane%dname(16) = "uxy"
      TSkplane%dname(17) = "uxz"
      TSkplane%dname(18) = "vxy"
      TSkplane%dname(19) = "vyy"
      TSkplane%dname(20) = "vyz"
      TSkplane%dname(21) = "wxz"
      TSkplane%dname(22) = "wyz"
      TSkplane%dname(23) = "wzz"
      TSkplane%dname(24) = "uk"
      TSkplane%dname(25) = "vk"
      TSkplane%dname(26) = "wk"
!      TSkplane%dname(27) = "pk"
!      TSkplane%dname(28) = "Tk"
...
!      TSkplane%info_1st_array(3) =  iskip_k_inp
    ...
    subroutine InitTSiplane_HDF5()
      ...
      TSiplane%dname(8) = "uz"
      TSiplane%dname(9) = "vx"
      TSiplane%dname(10) = "vy"
      TSiplane%dname(11) = "vz"
      TSiplane%dname(12) = "wx"
      TSiplane%dname(13) = "wy"
      TSiplane%dname(14) = "wz"
      TSiplane%dname(15) = "uxx"
      TSiplane%dname(16) = "uxy"
      TSiplane%dname(17) = "uxz"
      TSiplane%dname(18) = "vxy"
      TSiplane%dname(19) = "vyy"
      TSiplane%dname(20) = "vyz"
      TSiplane%dname(21) = "wxz"
      TSiplane%dname(22) = "wyz"
      TSiplane%dname(23) = "wzz"
      TSiplane%dname(24) = "ui"
      TSiplane%dname(25) = "vi"
      TSiplane%dname(26) = "wi"
!      TSiplane%dname(27) = "pi"
!      TSiplane%dname(28) = "Ti"
...
!      TSiplane%info_1st_array(3) =  jskip_i_inp
    ...
    subroutine InitTSjplane_HDF5()
      ...
      TSjplane%dname(8) = "uz"
      TSjplane%dname(9) = "vx"
      TSjplane%dname(10) = "vy"
      TSjplane%dname(11) = "vz"
      TSjplane%dname(12) = "wx"
      TSjplane%dname(13) = "wy"
      TSjplane%dname(14) = "wz"
      TSjplane%dname(15) = "uxx"
      TSjplane%dname(16) = "uxy"
      TSjplane%dname(17) = "uxz"
      TSjplane%dname(18) = "vxy"
      TSjplane%dname(19) = "vyy"
      TSjplane%dname(20) = "vyz"
      TSjplane%dname(21) = "wxz"
      TSjplane%dname(22) = "wyz"
      TSjplane%dname(23) = "wzz"
      TSjplane%dname(24) = "uj"
      TSjplane%dname(25) = "vj"
      TSjplane%dname(26) = "wj"
!      TSjplane%dname(27) = "pj"
!      TSjplane%dname(28) = "Tj"
