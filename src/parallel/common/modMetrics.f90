...
contains
    function Calmm_P(iin,jin,kin,idim, jdim, kdim, x, y, z)
    ...
    real(8), intent(in) :: x(1:kdim,-1:idim-2,-1:jdim-2), y(1:kdim,-1:idim-2,-1:jdim-2), z(1:kdim,-1:idim-2,-1:jdim-2)
...
!    integer :: idim, jdim, kdim
    ...
    Calmm_P = mm
    end function Calmm_P

    function Calmet_P(mm)
